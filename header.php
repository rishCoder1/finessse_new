...
<script defer src="https://www.googletagmanager.com/gtag/js?id=UA-119519475-1"></script>
<script>
...
<link rel="shortcut icon" type="image/x-icon" href="https://www.finessse.digital/public/images/Fav-Icon.ico">	
<title><?php echo $title;?></title>
<meta name="description" content="<?php echo $description;?>">
<meta name="keywords" content="<?php echo $keyword;?>"/>
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link rel="dns-prefetch" href=“https://www.finessse.digital/”>
<?php foreach(@$css as $css_name): 
    echo $css_name;
 endforeach; ?>

<style>
.new-year-left{ display:none; position:fixed; left:5px; top:0px; /*width:7.22%;*/ z-index:1001; }
.new-year-right{ display:none; position:fixed; right:0px; top:0px; /*width:8.9%;*/ z-index:1001;}

@media only screen and (max-width: 1348px) {
.new-year-left{ display:none; }
.new-year-right{ display:none; }
}
</style>
...
<?php /*?><a href="skype:+9810619956?call" class="pl-2"><i class="fab fa-skype"></i></a><?php */?>
	...
	<div class="row pl-sm-0 pr-sm-0 pl-4 pr-3">
		...
		<ul class="nav">
		   <li><a href="<?php echo $this->config->base_url();?>">Home</a></li>
		    <li class="overlay"><a href="<?php echo $this->config->base_url();?>about-us">About</a>
            <ul>
				<li><a href="<?php echo $this->config->base_url();?>about-us">About Finessse Interactive </a></li>
             </ul>
             <ul class="pd-13">					
				<li><a href="<?php echo $this->config->base_url();?>logo-launch-story">Logo Launch Story </a></li>
              </ul>
            </li>
...
<img src="<?php echo public_images;?>GooglePartner-Logo-01.svg" alt="Google Partner">
</div>
</header>
</div>
